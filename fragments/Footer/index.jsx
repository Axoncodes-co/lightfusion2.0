...
export default function Footer({ footerData, categories }) {
    ...
    return (<footer className={'container tertiary_bg vertical'}>
        ...
        <section className={'subcontainer horizontal spread'}>
            ...
            <p className={'subcontainer centerOnTablet font_l2_min primary_color righty weight_l3 wideonTablet'} style={{whiteSpace: "pre"}} dangerouslySetInnerHTML={{__html:footerData.attributes.socket}}></p>
        </section>
    </footer>)
}