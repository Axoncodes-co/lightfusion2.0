...
export default function Footer({categories}) {
    ...
    return (<footer className={'container tertiary_bg vertical'}>
        ...
        <section className={'subcontainer horizontal spread'}>
            ...
            <Text tag={'p'} text={`© 2020–2023 HomaPilot LLC & <a target="_blank" href="https://axoncodes.com" class="tertiary_color">Axoncodes</a> - Made with <svg class="${style.hearticon}" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 96 960 960" fill="#AD1457"><path d="m439 900-53-49Q262 736 171 631.5T80 413q0-90 60.5-150.5T290 202q51 0 101 24.5t89 80.5q44-56 91-80.5t99-24.5q89 0 149.5 60.5T880 413q0 114-91 218.5T574 851l-53 49q-17 16-41 16t-41-16Z"/></svg> in Arizona`} customclasses={'font_l2_min weight_l3 primary_color righty centerOnMobile'} />
        </section>
    </footer>)
}