...
export async function readLessons() {
    ...
    return jsonData.data.map(entity => {
      entity.attributes.createdAt = entity.attributes.createdAt.slice(0, entity.attributes.createdAt.indexOf('T')).replaceAll('-', '.')
      entity.attributes.updatedAt = entity.attributes.updatedAt.slice(0, entity.attributes.updatedAt.indexOf('T')).replaceAll('-', '.')
