...
import { fetchcategories } from "../../storecategories"
...
export async function readCategories() {
    ...
    const jsonData = process.env.READ_DATA == 'online' ? await fetchcategories() : JSON.parse(fs.readFileSync(path.join(process.cwd(), 'public/data/categories.json'), 'utf-8'))
