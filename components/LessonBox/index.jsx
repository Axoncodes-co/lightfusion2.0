        ...
        <article className={`subcontainer vertical round_l3 ${customclasses}`}>
            ...
            >
                <section className={`${style.inner} transition round_l3 subcontainer spread padding_l3`}
                    style={{
                        backgroundImage: `linear-gradient(0deg, #000000ba, #00000066, #0001, #0002), url(${thumbnail_url || ''})`,
                ...
                >
                    ...
                    <section className={'subcontainer round_l2 rowgap_l1 colgap_l1'}>
                        {tags.map((tag, key) => key > 1 ? '' : <Text key={key} /*link={`/tag/${tag.slug}`}*/ text={tag.Title} customclasses={`${style.opacity} tertiary_bg fitWidth round_l2`} textclasses={'secondary_font fitWidth primary_color font_l1 nomargin weight_l4 padding_slight'} />)}
                    </section>
                    <section className={'subcontainer vertical norowgap lefty'}>
                        <div className={'subcontainer horizontal horizontalTabletBreak fitWidth'}>
                            {/* Publish Date */}
                            <Text text={updateDate || publishDate} textclasses={'primary_color fitWidth font_l1 nomargin weight_l5'} />
