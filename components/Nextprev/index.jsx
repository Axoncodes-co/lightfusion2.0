...
export default function Nextprev({
    ...
    const prev = prevlink ? <Text
        ...
        customclasses={`fitWidth secondary_bg round_l2 padding ${style.minHeightByGoogle}`}
    /> : ''
    ...
    const next = nextlink ? <Text
        ...
        textclasses={'nomargin font_l4 weight_l5 widePadding_l1 primary_color'}
        customclasses={`rtl fitWidth secondary_bg round_l2 padding ${style.minHeightByGoogle}`}
    /> : ''
